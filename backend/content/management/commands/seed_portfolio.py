...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        profile = Profile.objects.create(
            ...
            about_heading="Ambitious, curious, driven to build.",
            about_copy=[
        ...
        for order, cert in enumerate(
            [
                ("LangChain, Pinecone & OpenAI: Build Next-Gen LLM Apps", "https://www.udemy.com/certificate/UC-bd103fa3-1610-42f7-8286-3e86abc2b771/"),
                ("AI Engineer Core Track: LLM Engineering, RAG, QLoRA, Agents", "https://www.udemy.com/certificate/UC-9b497638-2420-40f6-a375-eb02d45038b3/"),
                ("AI Leader: Generative AI & Agentic AI for Leaders & Founders", "https://www.udemy.com/certificate/UC-7bccd45a-3abd-401a-8b12-b3ffe030447a/"),
                ("AI Engineer Agentic Track: The Complete Agent & MCP Course", "https://www.udemy.com/certificate/UC-3388c666-70be-4556-9411-5451d12197c1/"),
                ("AI Engineer Production Track: Deploy LLMs & Agents at Scale", "https://www.udemy.com/certificate/UC-e33ff652-9bf1-4c33-acab-6505c7d313e4/"),
            ]
        ):
            Certification.objects.create(profile=profile, name=cert[0], url=cert[1], order=order)
